...
<div class="container prodAcc">
 <?php
  foreach ($allcategory as $key => $categorie) { ?>
   <div class="card" style="width: 18rem;">
      <div class="card-body">
         <h5 class="card-title"><?=$categorie['nom']?></h5>
         <p class="card-text"><?=$categorie['description']?></p>
         <div class="col-md-8 ">
            <a class="btn btn-outline-success" href="editCat.php?idCategorie=<?=$categorie['id']?>"><i class="bi bi-pencil-square"></i></a>
            <a class="btn btn-outline-danger" href="deleteCat.php?idCategorie=<?=$categorie['id']?>"><i class="bi bi-trash"></i></a>
         </div>
      </div>
   </div>
   <?php } ?>
